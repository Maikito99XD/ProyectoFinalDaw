        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Todos nuestros productos electronicos</h1>
                </div>
            </div>
        </header>
        <!-- Section-->
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    <div class="col mb-5" onclick="detalleProducto(<?=$productoElectronica['id']?>)">
                        <div class="card h-100">
                            ...
                            <!-- Product image-->
                            <img src="data:image/jpg;base64,<?= base64_encode($productoElectronica['img']);?>" height="200"/> 
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder"><?=$productoElectronica['nombre']?></h5>
                                    <!-- Product reviews-->
                                    <div class="d-flex justify-content-center small text-warning mb-2">
                                    <?php 
                                    for($i = 0;$i<$productoElectronica['puntuacion'];$i++){
                                        echo "<div class='bi-star-fill'></div>";
                                    }
                                    ?>
                                    </div>
                                    <!-- Product price-->
                                    <?=$productoElectronica['precio']?>€
                                </div>
                            </div>
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center">
                                    <form action="/daw/ProyectoTienda/utils/classes/carritoCookie.php" method="post">
                                        <input type="hidden" name="idProducto" value="<?=$productoElectronica['id']?>">
